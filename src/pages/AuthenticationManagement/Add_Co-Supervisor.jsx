    ...
    <div className style={{ backgroundImage: `url(${background})`, backgroundSize: 'cover' }}>
      <div className="main-container-signup">
        <div className="form-common">
          <h1><h1>Add a new Co-Supervisor</h1></h1>

          <Form
            layout="vertical"
            form={form}
            name="signupCo-Supervisor"
            onFinish={onFinish}
...
export default Add_CoSupervisor;
