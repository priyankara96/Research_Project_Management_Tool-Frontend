...
class panelmembertable extends Component {
  constructor(props) {
    super(props);
  ...
  filterData(posts, searchKey) {
    const result = posts.filter((post) =>
      ...
      post.designation.toLowerCase().includes(searchKey) ||
        ...
        <table class="table">
          <thead>
            <tr>
              ...
              <th scope="col">Panel Member's ID</th>
              <th scope="col">Panel Member's Designation  </th>
